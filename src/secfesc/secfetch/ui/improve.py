...
from secfesc.checks.network.services import SUSPICIOUS as SUSPICIOUS_SERVICES
from secfesc.secfetch.data.fixes import AUTO_FIXES, RISKY_FIXES, SYSCTL_FILE, SYSCTL_PERSISTENT
from secfesc.secfetch.ui.help import CHECK_DESCRIPTIONS
from secfesc.shared.colors import BOLD, CYAN, GREEN, RED, RESET, YELLOW
from secfesc.shared.types import CheckResult, FixItem
